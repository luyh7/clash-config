module.exports.parse = async (
  ...
  function merge(content, parser, value_type, method, key) {
    ...
    if (content[key] === undefined) {
      content[key] =
        value_type === yaml_value_type.yaml_object
          ? {}
          : value_type === yaml_value_type.yaml_array
          ? []
          : "";
    }
